#include <unordered_map> // unordered_map : hashtable 해시테이블을 위함
#include <map>

#include "BinarySearchTree.h"

// 해쉬 테이블 : 메모리를 주고 탐색시간을 취한다. (언리얼에서도 주로..)
// 탐색 : 상수  ... 해쉬충돌로 인한 체이닝에 따라 달라질 수 있다. 길어지는 시간이라면 자가균형탐색트리로 이용..
// 삽입 : 상수
// 충돌, 체이닝
...
// 해쉬테이블 vs 자가균형이진탐색트리
// 해쉬함수 후 충돌이 많이 일어날 경우.... 자기균형이진탐색트리 승
// 충돌이 적을 경우... 해쉬테이블 승
